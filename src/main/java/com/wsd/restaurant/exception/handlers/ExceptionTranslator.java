...
import com.wsd.restaurant.exception.BadRequestAlertException;
...
import com.wsd.restaurant.util.ErrorConstants;
import com.wsd.restaurant.util.HeaderUtil;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private String applicationName = "Restaurant APP";
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.wsd");
    }
}
