public Boolean isRppEcpExists(String fileId, String companyId) {
    ...
    sb.append("SELECT COUNT(*) ")
      ...
      .append("          FROM hist h ")
      .append("          WHERE h.payment_ts >= SYSDATE - 1 ")
      .append("      ), ")
      .append("      last_365 AS ( ")
      .append("          SELECT h.payment_ts ")
      .append("          FROM hist h ")
      .append("          WHERE h.payment_ts >= SYSDATE - 365 ")
      .append("      ) ")
      .append("      SELECT 1 ")
      .append("      FROM dual ")
      .append("      WHERE EXISTS (SELECT 1 FROM last_365) ")
      ...
      .append("                  AND p.payment_ts >= r.payment_ts - 365 ")
      .append("            ) ")
      .append("        ) ")
      .append("  ) ");
