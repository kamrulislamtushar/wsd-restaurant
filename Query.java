public Integer getEffectiveTxnCount(String companyId, String toAccNo, String productId) {
    ...
    sb.append("WITH hist AS ( ")
      ...
      .append("      AND t.FE_TRANSTMP < CURRENT_TIMESTAMP ")
      .append("), ")
      .append("recent_24h AS ( ")
      .append("    SELECT h.FE_TRANSTMP ")
      .append("    FROM hist h ")
      .append("    WHERE h.FE_TRANSTMP >= CURRENT_TIMESTAMP - INTERVAL '24' HOUR ")
      .append("), ")
      .append("older_365 AS ( ")
      .append("    SELECT h.FE_TRANSTMP ")
      .append("    FROM hist h ")
      .append("    WHERE h.FE_TRANSTMP >= CURRENT_TIMESTAMP - INTERVAL '365' DAY ")
      .append(") ")
      .append("SELECT CASE ")
      ...
      .append("                      AND p.FE_TRANSTMP >= r.FE_TRANSTMP - INTERVAL '365' DAY ")
      .append("              ) ")
      .append("         ) THEN 0 ")
